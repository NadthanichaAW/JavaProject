...
public class FXMLGameController implements Initializable {
    ...
    private Path TCplayer2_1P = new Path();
    private Path TCplayer2_2P = new Path();
    private Path TCplayer1_1P = new Path();
    private Path TCplayer1_2P = new Path();
        
    private PathTransition TCplayer2_1PT = new PathTransition();
    private PathTransition TCplayer2_2PT = new PathTransition();     
    private PathTransition TCplayer1_1PT = new PathTransition();
...
//----------------------------sigleplayer------------------------//
    ...
    private void handleButtonplayMutiplae(MouseEvent event) {       
        ...
        cardplayer1_2.setImage(image[2]); //first card round one
        firstcard2.setImage(imageback);
        card1_1.setImage(image[0]); //first card round one
        card2_1.setImage(image[1]); //first card round one
        card2_2.setImage(image[3]); //first card round one
        ...
        if (deck[2] > deck[3]) {
            ...
            p1.add(deck[0]);
            p1.add(deck[2]);
            firstcard2.setScaleX(0.6);//up small
            ...
            card2_1.setScaleX(0.6);//up small
            ...
            card2_2.setScaleX(0.6);//up
            card2_2.setScaleY(0.6);//up
            ...
            TCplayer2_2.setDelay(Duration.valueOf("1000ms"));
...
//            TCplayer2_2.setDuration(Duration.millis(2000));
            ...
            jack.setDelay(Duration.ONE);
            TCplayer1_2.setDelay(Duration.valueOf("1000ms"));
...
//            TCplayer1_1.setToX(-100);
            ...
            //new JackInTheBox(cardplayer1_2).setCycleCount(1).setDelay(Duration.valueOf("100ms")).play();
             TCplayer1_2.setNode(cardplayer1_2);
            TCplayer1_2.setDuration(Duration.millis(300));
...
//            TCplayer2_1.setToX(150);
           ...
           // new JackInTheBox(card2_2).setCycleCount(1).setDelay(Duration.valueOf("100ms")).play();
            TCplayer2_2.setNode(card2_2);
